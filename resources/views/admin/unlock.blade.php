		...
		<div class="col-md-offset-4 col-md-4 col-xs-10 col-xs-offset-1">
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				  	<p class="text-muted">Vous devez vous munir de votre clé de déverrouillage afin d'accéder à vos pouvoirs d'administrateur.</p>
					<form action="{{ url('admin/unlock') }}" method="POST" class="form-signin">
